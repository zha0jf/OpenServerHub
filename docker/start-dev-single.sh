...
check_docker() {
    ...
    echo -e "${BLUE}ℹ  单容器开发环境配置：SQLite + 热重载 + 监控组件${NC}"
...
GRAFANA_API_KEY=eyJrIjoiWlhRbG9sY3B3VlF0cEpOcG5aVlZVMlF6TlV4b09KNlciLCJuIjoib3BlbnNlcnZlcmh1Yi1kZXYiLCJpZCI6MX0=
